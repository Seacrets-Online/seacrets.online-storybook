...
import LanguagePopper, {
  type LanguageOption,
} from "../molecules/LanguagePopper";
import Text from "../atoms/Text";
import { SeacretsLogo } from "../atoms/SeacretsLogo";
...
export interface LoginTemplateProps extends BoxProps {
  ...
  /** Show the Seacrets logo (only in login variant) */
  showLogo?: boolean;
          ...
          {isForgotPassword ? (
            ...
            <>
              ...
              <AuthForm
                onSubmit={onLogin}
                onForgotPassword={
                  onForgotPassword ? handleForgotPassword : undefined
                }
