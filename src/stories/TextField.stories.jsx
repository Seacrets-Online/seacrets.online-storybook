...
export default {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "A Material Design 3 compliant text input component with multiple variants and states. All styling uses design tokens - no hardcoded colors.",
      },
    },
  },
  tags: ["autodocs"],
...
export const ErrorState = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Error state with error text. The label and border turn red, and error text is displayed.",
      },
    },
  },
};
...
export const States = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "TextField component supports all M3 states: default, focus, with value, and disabled. States are implemented using design tokens.",
      },
    },
  },
};
...
export const InputTypes = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "TextField supports various HTML input types: text, email, password, number, tel, and url.",
      },
    },
  },
};
...
export const Accessibility = {
  render: () => (
    ...
    >
      <div style={{ width: "100%" }}>
        ...
        >
          TextFields are keyboard accessible. Use Tab to navigate between
          fields, Enter to submit forms.
        </p>
        <div
          style={{
            display: "flex",
      ...
      <div style={{ width: "100%" }}>
        ...
        >
          TextFields automatically associate labels with inputs. aria-label can
          be used when a visible label is not present.
        </p>
        <TextField
          variant="filled"
      ...
      <div style={{ width: "100%" }}>
        ...
        >
          Required fields have aria-required="true" and show an asterisk (*)
          next to the label.
        </p>
        <TextField
          variant="filled"
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Accessibility features: keyboard navigation, ARIA labels, error announcements, and required field indicators.",
      },
    },
  },
};
...
export const Controlled = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Controlled TextField example - the value is managed by React state.",
      },
    },
  },
};
...
export const AllVariants = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Both Material Design 3 TextField variants: Filled and Outlined.",
      },
    },
  },
};
...
export const InteractiveStates = {
    ...
    return (
      ...
      >
        <div>
          ...
          >
            Type in the fields below to see how they handle different states.
            The component tracks focus and value states internally.
          </p>
          <TextField
            variant="filled"
            label="Email"
            ...
            placeholder="user@example.com"
            helperText={
              email ? "Valid email format" : "Enter your email address"
            }
          />
          <TextField
            variant="filled"
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Interactive demo showing how TextField handles focus, value, and error states dynamically. The component internally tracks whether it has a value for potential future enhancements.",
      },
    },
  },
};
