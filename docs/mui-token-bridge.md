...
Guide for consuming MD3 design tokens in MUI components. Token export standard: [TOKEN_EXPORT.md](./TOKEN_EXPORT.md).

## Architecture

```
tokens.json (W3C DTCG) -> style-dictionary -> src/style-dictionary-dist/theme.css
                                            -> src/utils/colors.generated.ts
                                            -> src/utils/typography.generated.ts
                                            -> src/utils/spacing.generated.ts
                                |
                                v
...
All from `tokens.json` via Style Dictionary (see [TOKEN_EXPORT.md](./TOKEN_EXPORT.md)):

- **theme.css**: CSS variables (`--md-sys-color-*`, `--md-sys-typography-*`)
  - Light: `:root`
  - Dark: `[data-theme="dark"]`
- **TypeScript (generated)**:
  - Colors: `src/utils/colors.generated.ts`
  - Typography: `src/utils/typography.generated.ts` (via `src/utils/typography.ts`)
  - Spacing: `src/utils/spacing.generated.ts`
- **TypeScript (manual)**: `src/utils/shapes.ts` (until Figma exports shape tokens)
...
Generated by Style Dictionary from typography tokens in `tokens.json`, then mapped from `src/utils/typography.ts` into MUI variants inside `src/theme/mui/createTheme.ts`:
